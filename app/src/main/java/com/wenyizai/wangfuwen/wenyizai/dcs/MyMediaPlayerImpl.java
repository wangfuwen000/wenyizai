...
public class MyMediaPlayerImpl implements IMediaPlayer {
    ...
    public MyMediaPlayerImpl() {
        ...
        // 读取音量和静音的数据
        currentVolume = (float) MediaPlayerPreferenceUtil.get(MyApplication.getAppContext(),
                KEY_SP_VOLUME, 0.8f);
        isMute = (boolean) MediaPlayerPreferenceUtil.get(MyApplication.getAppContext(),
                KEY_SP_MUTE, false);
        // LinkedList
        ...
        telephonyManager = (TelephonyManager)
                MyApplication.getAppContext().getSystemService(Service.TELEPHONY_SERVICE);
    ...
    public void setVolume(float volume) {
        ...
        //  保存数据
        MediaPlayerPreferenceUtil.put(MyApplication.getAppContext(),
